# ☁️ What is an Amazon EC2 Instance?

---

## 📌 Introduction

An **Amazon EC2 Instance** is a virtual server provided by **Amazon Web Services (AWS)** that runs applications in the cloud.

Instead of buying physical servers, users can launch virtual machines on AWS infrastructure within minutes. These virtual machines are called **EC2 Instances**.

An EC2 instance behaves like a real computer and includes:
...
## 🖼️ EC2 Instance Concept Diagram

<img width="1000" height="905" alt="ec2 2" src="https://github.com/user-attachments/assets/377f07db-f49c-4a1a-b9e7-e916e36f98fc" />


---

## ⚙️ How EC2 Instance Works
...
## 🏗️ EC2 Instance Architecture Diagram

<img width="600" height="465" alt="ec2 3" src="https://github.com/user-attachments/assets/a8d65dfd-e4c7-40dc-820e-deaa2c3e4f48" />
...
Represents the processing power allocated to the instance.

---

### 4️⃣ Memory (RAM)

Used for running applications and processes.
...
<img width="549" height="382" alt="ec2 4" src="https://github.com/user-attachments/assets/9b589ce0-062a-4a35-af03-3fd68ae90fa7" />
...
You control it like your personal computer, while AWS manages the physical infrastructure.
